    ...
    switch (cmd) {
      ...
      folders.forEach((folder) => {
        if(!fs.existsSync(folder)){
            ...
            console.log("Pasta: ", folder, "ja criado.")
        }
      });
      //desafio para criar logica e arquivos. Se passar o comando node ex2 html --complete
      //deve criar os files do array files.
}
...
/*if(!fs.existsSync(dir)){
    fs.mkdir(dir,(err)=>{
        //se der um erro, ele vai retornar um erro e para o processo.
        if (err) throw err;
        //se passar do throw ele vai executar o código abaixo.
        console.log(`Diretódio ${dir} criado com sucesso`);
    });
} else {
